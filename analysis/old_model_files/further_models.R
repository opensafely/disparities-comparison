...
model_outputs_list <- list(rsv_mild_ethnicity_further_output, rsv_severe_ethnicity_further_output,
                           ...
                           all_cause_mortality_ethnicity_further_output, rsv_mild_ses_further_output,
                           rsv_severe_ses_further_output, rsv_mortality_ses_further_output,
                           flu_mild_ses_further_output, flu_severe_ses_further_output,
                           flu_mortality_ses_further_output, all_cause_mortality_ses_further_output,
                           rsv_mild_hh_comp_further_output, rsv_severe_hh_comp_further_output,
...
if (length(args) == 0) {
  model_outputs %>%
    write_csv(file = paste0(here::here("output", "results", "models"), "/", 
                            "further_model_outputs_", cohort, "_", year(study_start_date), 
