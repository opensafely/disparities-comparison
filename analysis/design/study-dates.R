...
study_dates <- tibble::lst(
  ...
  season2_start_date = ymd("2017-09-01"), #start of first season
  season2_end_date = ymd("2018-08-31"), #end of first season
  season3_start_date = ymd("2018-09-01"), #start of first season
  season3_end_date = ymd("2019-08-31"), #end of first season
  season4_start_date = ymd("2019-09-01"), #start of first season
  season4_end_date = ymd("2020-08-31"), #end of first season
  season5_start_date = ymd("2020-09-01"), #start of first season
  season5_end_date = ymd("2021-08-31"), #end of first season
