...
if (cohort == "infants_subgroup") {
  ...
  if (too_few_events_mild) {
    ...
    flu_mild_ses_hh_comp_output <- tidy(flu_mild_ses_hh_comp, conf.int = TRUE)
  ...
  if (too_few_events_severe) {
    ...
    flu_severe_ses_hh_comp <- glm(flu_secondary_inf ~ imd_quintile +
                                  ...
                                  data = df_input, family = poisson)
    flu_severe_ses_hh_comp_output <- tidy(flu_severe_ses_hh_comp, conf.int = TRUE)
  ...
  #                                  data = df_input, family = poisson)
  # flu_mortality_ses_hh_comp_output <- tidy(flu_mortality_ses_hh_comp, conf.int = TRUE)
