...
if (cohort == "infants_subgroup") {
  ...
  if (too_few_events_mild) {
    ...
    flu_mild_ethnicity_hh_comp_further_output <- tidy(flu_mild_ethnicity_hh_comp_further, conf.int = TRUE)
  ...
  if (too_few_events_severe) {
    ...
    #create data frame with same columns as model output creates
    flu_severe_ethnicity_hh_comp_further_output <- data.frame(term = "too few events",
                                                              estimate = NA,
                                                              std.error = NA,
                                                              statistic = NA,
                                                              p.value = NA,
    ...
    flu_severe_ethnicity_hh_comp_further <- glm(flu_secondary_inf ~ latest_ethnicity_group +
                                                ...
                                                data = df_input, family = poisson)
    flu_severe_ethnicity_hh_comp_further_output <- tidy(flu_severe_ethnicity_hh_comp_further, conf.int = TRUE)
  ...
  #                                        data = df_input, family = poisson)
  # flu_mortality_ethnicity_hh_comp_further_output <- tidy(flu_mortality_ethnicity_hh_comp_further, conf.int = TRUE)  
  ...
  if (too_few_events_mild) {
    ...
    #create data frame with same columns as model output creates
    flu_mild_ethnicity_hh_comp_further_output <- data.frame(term = "too few events",
                                                            estimate = NA,
                                                            std.error = NA,
                                                            statistic = NA,
                                                            p.value = NA,
