...
# age_band (and other covariates) are taken at start of follow-up — a single
# patient-level age-at-event is not well-defined when events fall in different months.
