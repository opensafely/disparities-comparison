...
#} else {
  ...
  rsv_mild_full_further_output <- tidy(rsv_mild_full_further)
  ...
  rsv_severe_full_further <- glm(rsv_secondary_inf ~ latest_ethnicity_group + 
                                 ...
                                 data = df_input, family = poisson)
  rsv_severe_full_further_output <- tidy(rsv_severe_full_further)
  ...
  rsv_mortality_full_further <- glm(rsv_mortality ~ latest_ethnicity_group +
                                    ...
                                    data = df_input, family = poisson)
  rsv_mortality_full_further_output <- tidy(rsv_mortality_full_further)
