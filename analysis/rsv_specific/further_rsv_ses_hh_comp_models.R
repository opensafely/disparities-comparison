...
#} else {
  ...
  rsv_mild_ses_hh_comp_further_output <- tidy(rsv_mild_ses_hh_comp_further)
  ...
  rsv_severe_ses_hh_comp_further <- glm(rsv_secondary_inf ~ imd_quintile +
                                        ...
                                        data = df_input, family = poisson)
  rsv_severe_ses_hh_comp_further_output <- tidy(rsv_severe_ses_hh_comp_further)
  
  #rsv mortality by socioeconomic status and household composition
  rsv_mortality_ses_hh_comp_further <- glm(rsv_mortality ~ imd_quintile + 
                                             composition_category + age_band + 
                                             sex + rurality_classification +
                                             prior_flu_vaccination +
                                             flu_vaccination +
                                           ...
                                           data = df_input, family = poisson)
  rsv_mortality_ses_hh_comp_further_output <- tidy(rsv_mortality_ses_hh_comp_further)
