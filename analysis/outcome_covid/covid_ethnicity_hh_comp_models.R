...
if (cohort == "infants_subgroup") {
  ...
  if (too_few_events_mild) {
    ...
    covid_mild_ethnicity_hh_comp_output <- data.frame(term = "too few events",
                                                      estimate = NA,
                                                      std.error = NA,
                                                      statistic = NA,
                                                      p.value = NA,
    ...
    covid_mild_ethnicity_hh_comp_output <- tidy(covid_mild_ethnicity_hh_comp, conf.int = TRUE)
  ...
  if (too_few_events_severe) {
    ...
    #create data frame with same columns as model output creates
    covid_severe_ethnicity_hh_comp_output <- data.frame(term = "too few events",
                                                        estimate = NA,
                                                        std.error = NA,
                                                        statistic = NA,
                                                        p.value = NA,
    ...
    covid_severe_ethnicity_hh_comp <- glm(covid_secondary_inf ~ latest_ethnicity_group +
                                          ...
                                          data = df_input, family = poisson)
    covid_severe_ethnicity_hh_comp_output <- tidy(covid_severe_ethnicity_hh_comp, conf.int = TRUE)
  ...
  #                                          data = df_input, family = poisson)
  # covid_mortality_ethnicity_hh_comp_output <- tidy(covid_mortality_ethnicity_hh_comp, conf.int = TRUE)
