...
if (cohort == "infants" | cohort == "infants_subgroup") {
  ...
  collated_model_outputs_rsv_further = rbind(
    ...
    %>% mutate(model_type = "ses", codelist_type = "specific", 
               investigation_type = "primary", subset = "2020_21"),
    read_csv(here::here("output", "results", "models", "rsv_primary", 
                        paste0("further_rsv_hh_comp_model_outputs_", 
                               cohort, "_2020_2021_specific_primary.csv")))
    ...
    %>% mutate(model_type = "ethnicity_ses", codelist_type = "specific", 
               investigation_type = "primary", subset = "2020_21"),
    read_csv(here::here("output", "results", "models", "rsv_primary", 
                        paste0("further_rsv_ethnicity_hh_comp_model_outputs_", 
                               cohort, "_2020_2021_specific_primary.csv"))) 
    %>% mutate(model_type = "ethnicity_composition", codelist_type = "specific", 
               investigation_type = "primary", subset = "2020_21"),
    read_csv(here::here("output", "results", "models", "rsv_primary", 
                        paste0("further_rsv_ses_hh_comp_model_outputs_", 
                               cohort, "_2020_2021_specific_primary.csv"))) 
    %>% mutate(model_type = "ses_composition", codelist_type = "specific", 
               investigation_type = "primary", subset = "2020_21"),
    read_csv(here::here("output", "results", "models", "rsv_primary", 
                        paste0("further_rsv_full_model_outputs_", 
                               cohort, "_2020_2021_specific_primary.csv"))) 
...
write_csv(collated_model_outputs_rsv_further, 
          ...
          "/", cohort, "_further_rsv_model_outputs_collated.csv"))
