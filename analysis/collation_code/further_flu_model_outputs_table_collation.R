...
collated_model_outputs_flu_further = rbind(
  read_csv(here::here("output", "results", "models", "flu_specific_primary", 
  ...
  %>% mutate(model_type = "ses", codelist_type = "specific", 
             investigation_type = "primary", subset = "2020_21"),
  read_csv(here::here("output", "results", "models", "flu_specific_primary", 
                      paste0("further_flu_hh_comp_model_outputs_", 
                             cohort, "_2020_2021_specific_primary.csv")))
  ...
  %>% mutate(model_type = "ethnicity_ses", codelist_type = "specific", 
             investigation_type = "primary", subset = "2020_21"),
  read_csv(here::here("output", "results", "models", "flu_specific_primary", 
                      paste0("further_flu_ethnicity_hh_comp_model_outputs_", 
                             cohort, "_2020_2021_specific_primary.csv"))) 
  %>% mutate(model_type = "ethnicity_composition", codelist_type = "specific", 
             investigation_type = "primary", subset = "2020_21"),
  read_csv(here::here("output", "results", "models", "flu_specific_primary", 
                      paste0("further_flu_ses_hh_comp_model_outputs_", 
                             cohort, "_2020_2021_specific_primary.csv"))) 
  %>% mutate(model_type = "ses_composition", codelist_type = "specific", 
             investigation_type = "primary", subset = "2020_21"),
  read_csv(here::here("output", "results", "models", "flu_specific_primary", 
                      paste0("further_flu_full_model_outputs_", 
                             cohort, "_2020_2021_specific_primary.csv"))) 
...
write_csv(collated_model_outputs_flu_further, 
          ...
          "/", cohort, "_further_flu_model_outputs_collated.csv"))
