...
collated_model_outputs_overall_covid = rbind(
  read_csv(here::here("output", "results", "models", "covid_overall",
...
#save as csv
write_csv(collated_model_outputs_overall_covid, 
          paste0(here::here("output", "collated", "analytic"),
          "/", cohort, "_overall_covid_model_outputs_collated.csv"))
