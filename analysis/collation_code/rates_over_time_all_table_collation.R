...
#rsv
collated_rates_over_time_all_rsv = rbind(
  read_csv(here::here("output", "results", "rates", "weekly", "all",
           paste0("rates_over_time_all_rsv", "_", cohort,
...
#save as csv
write_csv(collated_rates_over_time_all_rsv, paste0(here::here("output",
          "collated", "descriptive", "over_time"), 
          "/", cohort, "_rates_over_time_all_all_rsv.csv"))

#flu
collated_rates_over_time_all_flu = rbind(
  read_csv(here::here("output", "results", "rates", "weekly", "all",
           paste0("rates_over_time_all_flu", "_", cohort,
           "_2016_2017_specific_primary.csv"))) %>%
    mutate(subset = "2016_17", codelist_type = "specific"),
  read_csv(here::here("output", "results", "rates", "weekly", "all",
           paste0("rates_over_time_all_flu", "_", cohort,
...
#save as csv
write_csv(collated_rates_over_time_all_flu, paste0(here::here("output",
          "collated", "descriptive", "over_time"), 
          "/", cohort, "_rates_over_time_all_all_flu.csv"))

#covid
collated_rates_over_time_all_covid = rbind(
  read_csv(here::here("output", "results", "rates", "weekly", "all",
           paste0("rates_over_time_all_covid", "_", cohort,
           "_2019_2020_specific_primary.csv"))) %>%
    mutate(subset = "2019_20", codelist_type = "specific"),
  read_csv(here::here("output", "results", "rates", "weekly", "all",
           paste0("rates_over_time_all_covid", "_", cohort,
...
#save as csv
write_csv(collated_rates_over_time_all_covid, paste0(here::here("output",
          "collated", "descriptive", "over_time"), 
          "/", cohort, "_rates_over_time_all_all_covid.csv"))

#overall
collated_rates_over_time_all_overall_resp = rbind(
  read_csv(here::here("output", "results", "rates", "weekly", "all",
           paste0("rates_over_time_all_overall_resp", "_", cohort,
           "_2016_2017_sensitive_primary.csv"))) %>%
    mutate(subset = "2016_17", codelist_type = "sensitive"),
  read_csv(here::here("output", "results", "rates", "weekly", "all",
           paste0("rates_over_time_all_overall_resp", "_", cohort,
...
#save as csv
write_csv(collated_rates_over_time_all_overall_resp, paste0(here::here("output",
          "collated", "descriptive", "over_time"), 
          "/", cohort, "_rates_over_time_all_all_overall_resp.csv"))
