...
collated_model_outputs_covid_sensitivity = rbind(
...
#save as csv
write_csv(collated_model_outputs_covid_sensitivity, paste0(here::here("output", "collated", "analytic"),
          "/", cohort, "_covid_sensitivity_model_outputs_collated.csv"))
