...
collated_model_outputs_overall_and_all_cause = rbind(
  # read_csv(here::here("output", "results", "models", "overall_and_all_cause_primary", 
  #                     paste0("further_overall_and_all_cause_ethnicity_model_outputs_", 
  ...
  # read_csv(here::here("output", "results", "models", "overall_and_all_cause_primary", 
  #                     paste0("further_overall_and_all_cause_ses_model_outputs_", 
  #                            cohort, "_2016_2017_specific_primary.csv"))) 
  # %>% mutate(model_type = "ses", codelist_type = "specific", 
  #            investigation_type = "primary", subset = "2016_17"),
  # read_csv(here::here("output", "results", "models", "overall_and_all_cause_primary", 
  #                     paste0("further_overall_and_all_cause_ethnicity_ses_model_outputs_", 
  #                            cohort, "_2016_2017_specific_primary.csv"))) 
  ...
  #            investigation_type = "primary", subset = "2020_21"),
  # read_csv(here::here("output", "results", "models", "overall_and_all_cause_primary", 
  #                     paste0("further_overall_and_all_cause_hh_comp_model_outputs_", 
  #                            cohort, "_2020_2021_specific_primary.csv")))
  ...
  #            investigation_type = "primary", subset = "2020_21"),
  # read_csv(here::here("output", "results", "models", "overall_and_all_cause_primary", 
  #                     paste0("further_overall_and_all_cause_ethnicity_hh_comp_model_outputs_", 
  #                            cohort, "_2020_2021_specific_primary.csv"))) 
  # %>% mutate(model_type = "ethnicity_composition", codelist_type = "specific", 
  #            investigation_type = "primary", subset = "2020_21"),
  # read_csv(here::here("output", "results", "models", "overall_and_all_cause_primary", 
  #                     paste0("further_overall_and_all_cause_ses_hh_comp_model_outputs_", 
  #                            cohort, "_2020_2021_specific_primary.csv"))) 
  # %>% mutate(model_type = "ses_composition", codelist_type = "specific", 
  #            investigation_type = "primary", subset = "2020_21"),
  # read_csv(here::here("output", "results", "models", "overall_and_all_cause_primary", 
  #                     paste0("further_overall_and_all_cause_full_model_outputs_", 
  #                            cohort, "_2020_2021_specific_primary.csv"))) 
