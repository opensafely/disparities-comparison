...
#overall
older_adults_overall_mild <- rate_viz(
  df_input, "Overall Respiratory", "Mild")
older_adults_season_overall_mild <- rate_viz_season(
  df_input, "Overall Respiratory", "Mild")
older_adults_characters_overall_mild <- rate_viz_mult(
  df_input, "Overall Respiratory", "Mild")
older_adults_overall_severe <- rate_viz(
  df_input, "Overall Respiratory", "Severe")
older_adults_season_overall_severe <- rate_viz_season(
  df_input, "Overall Respiratory", "Severe")
older_adults_characters_overall_severe <- rate_viz_mult(
  df_input, "Overall Respiratory", "Severe")
...
plotlist1 <- list(
  ...
  older_adults_overall_mild,
  older_adults_overall_severe
)
...
plotlist2 <- list(
  ...
  older_adults_season_overall_mild,
  older_adults_season_overall_severe
)
plotlist3 <- list(
  ...
  older_adults_characters_overall_mild,
  older_adults_characters_overall_severe
)
...
for(p in plotlist1) {
  ...
  ggsave(here("post_check", "plots", "primary_analyses", "rates", cohort,
...
#overall
infants_overall_mild <- rate_viz(
  df_input, "Overall Respiratory", "Mild")
infants_season_overall_mild <- rate_viz_season(
  df_input, "Overall Respiratory", "Mild")
infants_characters_overall_mild <- rate_viz_mult(
  df_input, "Overall Respiratory", "Mild")
infants_overall_severe <- rate_viz(
  df_input, "Overall Respiratory", "Severe")
infants_season_overall_severe <- rate_viz_season(
  df_input, "Overall Respiratory", "Severe")
infants_characters_overall_severe <- rate_viz_mult(
  df_input, "Overall Respiratory", "Severe")
...
plotlist1 <- list(
  ...
  infants_overall_mild,
  infants_overall_severe
)
...
plotlist2 <- list(
  ...
  infants_season_overall_mild,
  infants_season_overall_severe
)
plotlist3 <- list(
  ...
  infants_characters_overall_mild,
...
#overall
infants_subgroup_overall_mild <- rate_viz(
  df_input, "Overall Respiratory", "Mild")
infants_subgroup_season_overall_mild <- rate_viz_season(
  df_input, "Overall Respiratory", "Mild")
infants_subgroup_characters_overall_mild <- rate_viz_mult(
  df_input, "Overall Respiratory", "Mild")
infants_subgroup_overall_severe <- rate_viz(
  df_input, "Overall Respiratory", "Severe")
infants_subgroup_season_overall_severe <- rate_viz_season(
  df_input, "Overall Respiratory", "Severe")
infants_subgroup_characters_overall_severe <- rate_viz_mult(
  df_input, "Overall Respiratory", "Severe")
...
plotlist1 <- list(
  ...
  infants_subgroup_overall_mild,
  infants_subgroup_overall_severe
)
...
plotlist2 <- list(
  ...
  infants_subgroup_season_overall_mild,
  infants_subgroup_season_overall_severe
)
plotlist3 <- list(
  ...
  infants_subgroup_characters_overall_mild,
  infants_subgroup_characters_overall_severe
)
