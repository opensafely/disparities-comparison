...
#ethnicity
flu_ethnicity_mild_spec <- forest_further(
  df_input, df_dummy, pathogen, "ethnicity", "Mild"
)$spec
flu_ethnicity_mild_sens <- forest_further(
  df_input, df_dummy, pathogen, "ethnicity", "Mild"
)$sens
flu_ethnicity_mild_spec_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "ethnicity", "Mild"
)$spec
flu_ethnicity_mild_sens_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "ethnicity", "Mild"
)$sens

#ses
flu_ses_mild_spec <- forest_further(
  df_input, df_dummy, pathogen, "ses", "Mild"
)$spec
flu_ses_mild_sens <- forest_further(
  df_input, df_dummy, pathogen, "ses", "Mild"
)$sens
flu_ses_mild_spec_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "ses", "Mild"
)$spec
flu_ses_mild_sens_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "ses", "Mild"
)$sens

#composition
flu_composition_mild_spec <- forest_further(
  df_input, df_dummy, pathogen, "composition", "Mild"
)$spec
flu_composition_mild_sens <- forest_further(
  df_input, df_dummy, pathogen, "composition", "Mild"
)$sens
flu_composition_mild_spec_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "composition", "Mild"
)$spec
flu_composition_mild_sens_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "composition", "Mild"
)$sens

#ethnicity & ses
flu_ethnicity_ses_mild_spec <- forest_further(
  df_input, df_dummy, pathogen, "ethnicity_ses", "Mild"
)$spec
flu_ethnicity_ses_mild_sens <- forest_further(
  df_input, df_dummy, pathogen, "ethnicity_ses", "Mild"
)$sens
flu_ethnicity_ses_mild_spec_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "ethnicity_ses", "Mild"
)$spec
flu_ethnicity_ses_mild_sens_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "ethnicity_ses", "Mild"
)$sens

#ethnicity & composition - too few events
flu_ethnicity_composition_mild_spec <- forest_further(
  df_input, df_dummy, pathogen, "ethnicity_composition", "Mild"
)$spec
flu_ethnicity_composition_mild_sens <- forest_further(
  df_input, df_dummy, pathogen, "ethnicity_composition", "Mild"
)$sens
flu_ethnicity_composition_mild_spec_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "ethnicity_composition", "Mild"
)$spec
flu_ethnicity_composition_mild_sens_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "ethnicity_composition", "Mild"
)$sens

#ses & composition
flu_ses_composition_mild_spec <- forest_further(
  df_input, df_dummy, pathogen, "ses_composition", "Mild"
)$spec
flu_ses_composition_mild_sens <- forest_further(
  df_input, df_dummy, pathogen, "ses_composition", "Mild"
)$sens
flu_ses_composition_mild_spec_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "ses_composition", "Mild"
)$spec
flu_ses_composition_mild_sens_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "ses_composition", "Mild"
)$sens

#full
flu_full_mild_spec <- forest_further(
  df_input, df_dummy, pathogen, "full", "Mild"
)$spec
flu_full_mild_sens <- forest_further(
  df_input, df_dummy, pathogen, "full", "Mild"
)$sens
flu_full_mild_spec_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "full", "Mild"
)$spec
flu_full_mild_sens_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "full", "Mild"
)$sens
...
#ethnicity
flu_ethnicity_severe_spec <- forest_further(
  df_input, df_dummy, pathogen, "ethnicity", "Severe"
)$spec
flu_ethnicity_severe_sens <- forest_further(
  df_input, df_dummy, pathogen, "ethnicity", "Severe"
)$sens
flu_ethnicity_severe_spec_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "ethnicity", "Severe"
)$spec
flu_ethnicity_severe_sens_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "ethnicity", "Severe"
)$sens

#ses
flu_ses_severe_spec <- forest_further(
  df_input, df_dummy, pathogen, "ses", "Severe"
)$spec
flu_ses_severe_sens <- forest_further(
  df_input, df_dummy, pathogen, "ses", "Severe"
)$sens
flu_ses_severe_spec_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "ses", "Severe"
)$spec
flu_ses_severe_sens_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "ses", "Severe"
)$sens

#composition
flu_composition_severe_spec <- forest_further(
  df_input, df_dummy, pathogen, "composition", "Severe"
)$spec
flu_composition_severe_sens <- forest_further(
  df_input, df_dummy, pathogen, "composition", "Severe"
)$sens
flu_composition_severe_spec_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "composition", "Severe"
)$spec
flu_composition_severe_sens_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "composition", "Severe"
)$sens

#ethnicity & ses
flu_ethnicity_ses_severe_spec <- forest_further(
  df_input, df_dummy, pathogen, "ethnicity_ses", "Severe"
)$spec
flu_ethnicity_ses_severe_sens <- forest_further(
  df_input, df_dummy, pathogen, "ethnicity_ses", "Severe"
)$sens
flu_ethnicity_ses_severe_spec_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "ethnicity_ses", "Severe"
)$spec
flu_ethnicity_ses_severe_sens_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "ethnicity_ses", "Severe"
)$sens

#ethnicity & composition
flu_ethnicity_composition_severe_spec <- forest_further(
  df_input, df_dummy, pathogen, "ethnicity_composition", "Severe"
)$spec
flu_ethnicity_composition_severe_sens <- forest_further(
  df_input, df_dummy, pathogen, "ethnicity_composition", "Severe"
)$sens
flu_ethnicity_composition_severe_spec_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "ethnicity_composition", "Severe"
)$spec
flu_ethnicity_composition_severe_sens_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "ethnicity_composition", "Severe"
)$sens

#ses & composition
flu_ses_composition_severe_spec <- forest_further(
  df_input, df_dummy, pathogen, "ses_composition", "Severe"
)$spec
flu_ses_composition_severe_sens <- forest_further(
  df_input, df_dummy, pathogen, "ses_composition", "Severe"
)$sens
flu_ses_composition_severe_spec_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "ses_composition", "Severe"
)$spec
flu_ses_composition_severe_sens_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "ses_composition", "Severe"
)$sens

#full
flu_full_severe_spec <- forest_further(
  df_input, df_dummy, pathogen, "full", "Severe"
)$spec
flu_full_severe_sens <- forest_further(
  df_input, df_dummy, pathogen, "full", "Severe"
)$sens
flu_full_severe_spec_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "full", "Severe"
)$spec
flu_full_severe_sens_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "full", "Severe"
)$sens
