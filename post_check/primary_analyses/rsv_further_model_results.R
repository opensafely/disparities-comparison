...
#ethnicity
rsv_ethnicity_mild_spec <- forest_further(
  df_input, df_dummy, pathogen, "ethnicity", "Mild"
)$spec
rsv_ethnicity_mild_sens <- forest_further(
  df_input, df_dummy, pathogen, "ethnicity", "Mild"
)$sens
rsv_ethnicity_mild_spec_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "ethnicity", "Mild"
)$spec
rsv_ethnicity_mild_sens_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "ethnicity", "Mild"
)$sens

#ses
rsv_ses_mild_spec <- forest_further(
  df_input, df_dummy, pathogen, "ses", "Mild"
)$spec
rsv_ses_mild_sens <- forest_further(
  df_input, df_dummy, pathogen, "ses", "Mild"
)$sens
rsv_ses_mild_spec_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "ses", "Mild"
)$spec
rsv_ses_mild_sens_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "ses", "Mild"
)$sens

#composition
rsv_composition_mild_spec <- forest_further(
  df_input, df_dummy, pathogen, "composition", "Mild"
)$spec
rsv_composition_mild_sens <- forest_further(
  df_input, df_dummy, pathogen, "composition", "Mild"
)$sens
rsv_composition_mild_spec_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "composition", "Mild"
)$spec
rsv_composition_mild_sens_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "composition", "Mild"
)$sens

#ethnicity & ses
rsv_ethnicity_ses_mild_spec <- forest_further(
  df_input, df_dummy, pathogen, "ethnicity_ses", "Mild"
)$spec
rsv_ethnicity_ses_mild_sens <- forest_further(
  df_input, df_dummy, pathogen, "ethnicity_ses", "Mild"
)$sens
rsv_ethnicity_ses_mild_spec_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "ethnicity_ses", "Mild"
)$spec
rsv_ethnicity_ses_mild_sens_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "ethnicity_ses", "Mild"
)$sens

#ethnicity & composition - too few events
rsv_ethnicity_composition_mild_spec <- forest_further(
  df_input, df_dummy, pathogen, "ethnicity_composition", "Mild"
)$spec
rsv_ethnicity_composition_mild_sens <- forest_further(
  df_input, df_dummy, pathogen, "ethnicity_composition", "Mild"
)$sens
rsv_ethnicity_composition_mild_spec_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "ethnicity_composition", "Mild"
)$spec
rsv_ethnicity_composition_mild_sens_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "ethnicity_composition", "Mild"
)$sens

#ses & composition
rsv_ses_composition_mild_spec <- forest_further(
  df_input, df_dummy, pathogen, "ses_composition", "Mild"
)$spec
rsv_ses_composition_mild_sens <- forest_further(
  df_input, df_dummy, pathogen, "ses_composition", "Mild"
)$sens
rsv_ses_composition_mild_spec_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "ses_composition", "Mild"
)$spec
rsv_ses_composition_mild_sens_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "ses_composition", "Mild"
)$sens

#full
rsv_full_mild_spec <- forest_further(
  df_input, df_dummy, pathogen, "full", "Mild"
)$spec
rsv_full_mild_sens <- forest_further(
  df_input, df_dummy, pathogen, "full", "Mild"
)$sens
rsv_full_mild_spec_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "full", "Mild"
)$spec
rsv_full_mild_sens_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "full", "Mild"
)$sens
...
#ethnicity
rsv_ethnicity_severe_spec <- forest_further(
  df_input, df_dummy, pathogen, "ethnicity", "Severe"
)$spec
rsv_ethnicity_severe_sens <- forest_further(
  df_input, df_dummy, pathogen, "ethnicity", "Severe"
)$sens
rsv_ethnicity_severe_spec_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "ethnicity", "Severe"
)$spec
rsv_ethnicity_severe_sens_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "ethnicity", "Severe"
)$sens

#ses
rsv_ses_severe_spec <- forest_further(
  df_input, df_dummy, pathogen, "ses", "Severe"
)$spec
rsv_ses_severe_sens <- forest_further(
  df_input, df_dummy, pathogen, "ses", "Severe"
)$sens
rsv_ses_severe_spec_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "ses", "Severe"
)$spec
rsv_ses_severe_sens_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "ses", "Severe"
)$sens

#composition
rsv_composition_severe_spec <- forest_further(
  df_input, df_dummy, pathogen, "composition", "Severe"
)$spec
rsv_composition_severe_sens <- forest_further(
  df_input, df_dummy, pathogen, "composition", "Severe"
)$sens
rsv_composition_severe_spec_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "composition", "Severe"
)$spec
rsv_composition_severe_sens_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "composition", "Severe"
)$sens

#ethnicity & ses
rsv_ethnicity_ses_severe_spec <- forest_further(
  df_input, df_dummy, pathogen, "ethnicity_ses", "Severe"
)$spec
rsv_ethnicity_ses_severe_sens <- forest_further(
  df_input, df_dummy, pathogen, "ethnicity_ses", "Severe"
)$sens
rsv_ethnicity_ses_severe_spec_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "ethnicity_ses", "Severe"
)$spec
rsv_ethnicity_ses_severe_sens_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "ethnicity_ses", "Severe"
)$sens

#ethnicity & composition
rsv_ethnicity_composition_severe_spec <- forest_further(
  df_input, df_dummy, pathogen, "ethnicity_composition", "Severe"
)$spec
rsv_ethnicity_composition_severe_sens <- forest_further(
  df_input, df_dummy, pathogen, "ethnicity_composition", "Severe"
)$sens
rsv_ethnicity_composition_severe_spec_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "ethnicity_composition", "Severe"
)$spec
rsv_ethnicity_composition_severe_sens_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "ethnicity_composition", "Severe"
)$sens

#ses & composition
rsv_ses_composition_severe_spec <- forest_further(
  df_input, df_dummy, pathogen, "ses_composition", "Severe"
)$spec
rsv_ses_composition_severe_sens <- forest_further(
  df_input, df_dummy, pathogen, "ses_composition", "Severe"
)$sens
rsv_ses_composition_severe_spec_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "ses_composition", "Severe"
)$spec
rsv_ses_composition_severe_sens_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "ses_composition", "Severe"
)$sens

#full
rsv_full_severe_spec <- forest_further(
  df_input, df_dummy, pathogen, "full", "Severe"
)$spec
rsv_full_severe_sens <- forest_further(
  df_input, df_dummy, pathogen, "full", "Severe"
)$sens
rsv_full_severe_spec_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "full", "Severe"
)$spec
rsv_full_severe_sens_alt <- forest_year_further(
  df_input, df_dummy, pathogen, "full", "Severe"
)$sens
