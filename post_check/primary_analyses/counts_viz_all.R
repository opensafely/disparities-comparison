...
df_input <- read_csv(here::here("post_check",
                     ...
                     "counts_over_time_all_monthly_", pathogen, ".csv")))

#create plot
rsv <- create_rolling_plots_overall_counts(df_input)$plot

#pull legend
legend <- create_rolling_plots_overall_counts(df_input)$legend
...
#create plot
flu <- create_rolling_plots_overall_counts(df_input)$plot
...
#create plot
covid <- create_rolling_plots_overall_counts(df_input)$plot

##plot together 

plot_col <- plot_grid(
  rsv + theme(axis.text.x = element_blank(), axis.ticks = element_blank()),
  flu + theme(axis.text.x = element_blank(), axis.ticks = element_blank()),
  covid,
  nrow = 3
)
...
ggsave(here::here("post_check", "plots", "primary_analyses",
      "counts", paste0(cohort, "_counts_over_time_all", ".png")),
...
# 
# #plot
# overall_resp <- create_rolling_plots_overall_counts(df_input)$plot
# legend2 <- create_rolling_plots_overall_counts(df_input)$legend
# 
# plot <- plot_grid(
#   overall_resp,
#   legend2,
...
#   NULL,
#   create_rolling_plots_overall_counts(df_input)$plot_mild,
#   NULL,
#   create_rolling_plots_overall_counts(df_input)$plot_severe,
#   ncol = 4,
