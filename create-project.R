...
action_specified <- function(cohort, season, dates, 
  ...
  splice(
    ...
    action(
      ...
      needs = list(glue("process_dataset_{cohort}_{season}_{codelist_type}_{investigation_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/further_rsv_ethnicity_model_outputs_{cohort}_{dates}_{codelist_type}_{investigation_type}.csv")),
    ),
    ...
    action(
      ...
      needs = list(glue("process_dataset_{cohort}_{season}_{codelist_type}_{investigation_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/further_flu_ethnicity_model_outputs_{cohort}_{dates}_{codelist_type}_{investigation_type}.csv")),
    ),
    ...
    action(
      ...
      needs = list(glue("process_dataset_{cohort}_{season}_{codelist_type}_{investigation_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/further_overall_and_all_cause_ethnicity_model_outputs_{cohort}_{dates}_{codelist_type}_{investigation_type}.csv")),
    ),
    ...
    action(
      ...
      needs = list(glue("process_dataset_{cohort}_{season}_{codelist_type}_{investigation_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/further_rsv_ses_model_outputs_{cohort}_{dates}_{codelist_type}_{investigation_type}.csv")),
    ),
    ...
    action(
      ...
      needs = list(glue("process_dataset_{cohort}_{season}_{codelist_type}_{investigation_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/further_flu_ses_model_outputs_{cohort}_{dates}_{codelist_type}_{investigation_type}.csv")),
    ),
    ...
    action(
      ...
      needs = list(glue("process_dataset_{cohort}_{season}_{codelist_type}_{investigation_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/further_overall_and_all_cause_ses_model_outputs_{cohort}_{dates}_{codelist_type}_{investigation_type}.csv")),
    ),
    ...
    action(
      ...
      needs = list(glue("process_dataset_{cohort}_{season}_{codelist_type}_{investigation_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/further_rsv_hh_comp_model_outputs_{cohort}_{dates}_{codelist_type}_{investigation_type}.csv")),
    ),
    ...
    action(
      ...
      needs = list(glue("process_dataset_{cohort}_{season}_{codelist_type}_{investigation_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/further_flu_hh_comp_model_outputs_{cohort}_{dates}_{codelist_type}_{investigation_type}.csv")),
    ),
    ...
    action(
      ...
      needs = list(glue("process_dataset_{cohort}_{season}_{codelist_type}_{investigation_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/further_overall_and_all_cause_hh_comp_model_outputs_{cohort}_{dates}_{codelist_type}_{investigation_type}.csv")),
    ),
    ...
    action(
      ...
      needs = list(glue("process_dataset_{cohort}_{season}_{codelist_type}_{investigation_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/further_rsv_ethnicity_ses_model_outputs_{cohort}_{dates}_{codelist_type}_{investigation_type}.csv")),
    ),
    ...
    action(
      ...
      needs = list(glue("process_dataset_{cohort}_{season}_{codelist_type}_{investigation_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/further_flu_ethnicity_ses_model_outputs_{cohort}_{dates}_{codelist_type}_{investigation_type}.csv")),
    ),
    ...
    action(
      ...
      needs = list(glue("process_dataset_{cohort}_{season}_{codelist_type}_{investigation_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/further_overall_and_all_cause_ethnicity_ses_model_outputs_{cohort}_{dates}_{codelist_type}_{investigation_type}.csv")),
    ),
    ...
    action(
      ...
      needs = list(glue("process_dataset_{cohort}_{season}_{codelist_type}_{investigation_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/further_rsv_ethnicity_hh_comp_model_outputs_{cohort}_{dates}_{codelist_type}_{investigation_type}.csv")),
    ),
    ...
    action(
      ...
      needs = list(glue("process_dataset_{cohort}_{season}_{codelist_type}_{investigation_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/further_flu_ethnicity_hh_comp_model_outputs_{cohort}_{dates}_{codelist_type}_{investigation_type}.csv")),
    ),
    ...
    action(
      ...
      needs = list(glue("process_dataset_{cohort}_{season}_{codelist_type}_{investigation_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/further_overall_and_all_cause_ethnicity_hh_comp_model_outputs_{cohort}_{dates}_{codelist_type}_{investigation_type}.csv")),
    ),
    ...
    action(
      ...
      needs = list(glue("process_dataset_{cohort}_{season}_{codelist_type}_{investigation_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/further_rsv_ses_hh_comp_model_outputs_{cohort}_{dates}_{codelist_type}_{investigation_type}.csv")),
    ),
    ...
    action(
      ...
      needs = list(glue("process_dataset_{cohort}_{season}_{codelist_type}_{investigation_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/further_flu_ses_hh_comp_model_outputs_{cohort}_{dates}_{codelist_type}_{investigation_type}.csv")),
    ),
    ...
    action(
      ...
      needs = list(glue("process_dataset_{cohort}_{season}_{codelist_type}_{investigation_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/further_overall_and_all_cause_ses_hh_comp_model_outputs_{cohort}_{dates}_{codelist_type}_{investigation_type}.csv")),
    ),
    ...
    action(
      ...
      needs = list(glue("process_dataset_{cohort}_{season}_{codelist_type}_{investigation_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/further_rsv_full_model_outputs_{cohort}_{dates}_{codelist_type}_{investigation_type}.csv")),
    ),
    ...
    action(
      ...
      needs = list(glue("process_dataset_{cohort}_{season}_{codelist_type}_{investigation_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/further_flu_full_model_outputs_{cohort}_{dates}_{codelist_type}_{investigation_type}.csv")),
    ),
    ...
    action(
      ...
      needs = list(glue("process_dataset_{cohort}_{season}_{codelist_type}_{investigation_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/further_overall_and_all_cause_full_model_outputs_{cohort}_{dates}_{codelist_type}_{investigation_type}.csv")),
    )
...
action_covid <- function(cohort, season, dates, codelist_type,
  ...
  splice(
    ...
    action(
      ...
      needs = list(glue("process_dataset_{cohort}_{season}_{codelist_type}_{investigation_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/further_covid_ethnicity_model_outputs_{cohort}_{dates}_{codelist_type}_{investigation_type}.csv")),
    ),
    ...
    action(
      ...
      needs = list(glue("process_dataset_{cohort}_{season}_{codelist_type}_{investigation_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/further_covid_ses_model_outputs_{cohort}_{dates}_{codelist_type}_{investigation_type}.csv")),
    ),
    ...
    action(
      ...
      needs = list(glue("process_dataset_{cohort}_{season}_{codelist_type}_{investigation_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/further_covid_hh_comp_model_outputs_{cohort}_{dates}_{codelist_type}_{investigation_type}.csv")),
    ),
    ...
    action(
      ...
      needs = list(glue("process_dataset_{cohort}_{season}_{codelist_type}_{investigation_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/further_covid_ethnicity_ses_model_outputs_{cohort}_{dates}_{codelist_type}_{investigation_type}.csv")),
    ),
    ...
    action(
      ...
      needs = list(glue("process_dataset_{cohort}_{season}_{codelist_type}_{investigation_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/further_covid_ethnicity_hh_comp_model_outputs_{cohort}_{dates}_{codelist_type}_{investigation_type}.csv")),
    ),
    ...
    action(
      ...
      needs = list(glue("process_dataset_{cohort}_{season}_{codelist_type}_{investigation_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/further_covid_ses_hh_comp_model_outputs_{cohort}_{dates}_{codelist_type}_{investigation_type}.csv")),
    ),
    ...
    action(
      ...
      needs = list(glue("process_dataset_{cohort}_{season}_{codelist_type}_{investigation_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/further_covid_full_model_outputs_{cohort}_{dates}_{codelist_type}_{investigation_type}.csv")),
    )
...
action_descriptive <- function(cohort, season, dates, 
                            codelist_type, investigation_type,
                            season_start_date, season_end_date) {
  ...
  splice(
    ...
    action(
      ...
      arguments = c(cohort, season, dates, codelist_type, investigation_type, 
                    season_start_date, season_end_date),
      needs = list(glue("process_dataset_{cohort}_{season}_sensitive_secondary")),
      moderately_sensitive = lst(
...
action_sensitivity <- function(cohort, season, dates, season_start_date, 
  ...
  splice(
    ...
    action(
      ...
      arguments = c(cohort, season, dates, codelist_type, investigation_type, 
                    season_start_date, season_end_date),
      needs = list(glue("process_dataset_sensitivity_{cohort}_{season}_{codelist_type}")),
      moderately_sensitive = lst(
...
action_finalise <- function(cohort) {
  ...
  splice(
    ...
    action(
      name = glue("collate_rsv_sensitive_model_outputs_tables_{cohort}_sensitivity"),
      run = glue("r:latest analysis/collation_code/rsv_sensitivity_model_outputs_table_collation.R {cohort}"),
      arguments = c(cohort),
    ...
    action(
      name = glue("collate_flu_sensitive_model_outputs_tables_{cohort}_sensitivity"),
      run = glue("r:latest analysis/collation_code/flu_sensitivity_model_outputs_table_collation.R {cohort}"),
      arguments = c(cohort),
    ...
    action(
      name = glue("collate_covid_sensitive_model_outputs_tables_{cohort}_sensitivity"),
      run = glue("r:latest analysis/collation_code/covid_sensitivity_model_outputs_table_collation.R {cohort}"),
      arguments = c(cohort),
    ...
    action(
      name = glue("collate_overall_and_all_cause_sensitive_model_outputs_tables_{cohort}_sensitivity"),
      run = glue("r:latest analysis/collation_code/overall_and_all_cause_sensitivity_model_outputs_table_collation.R {cohort}"),
      arguments = c(cohort),
...
actions_list <- splice(
  ...
  action_specified("infants", "s1", "2016_2017", "specific", "primary", "season1_start_date", "season1_end_date"),
  action_specified("infants", "s2", "2017_2018", "specific", "primary", "season2_start_date", "season2_end_date"),
  action_specified("infants", "s3", "2018_2019", "specific", "primary", "season3_start_date", "season3_end_date"),
  action_specified("infants", "s4", "2019_2020", "specific", "primary", "season4_start_date", "season4_end_date"),
  action_covid("infants", "s4", "2019_2020", "specific", "primary", "season4_start_date", "season4_end_date"),
  action_specified("infants", "s5", "2020_2021", "specific", "primary", "season5_start_date", "season5_end_date"),
  action_covid("infants", "s5", "2020_2021", "specific", "primary", "season5_start_date", "season5_end_date"),
  action_specified("infants", "s6", "2021_2022", "specific", "primary", "season6_start_date", "season6_end_date"),
  action_covid("infants", "s6", "2021_2022", "specific", "primary", "season6_start_date", "season6_end_date"),
  ...
  action_specified("infants", "s1", "2016_2017", "sensitive", "primary", "season1_start_date", "season1_end_date"),
  action_specified("infants", "s2", "2017_2018", "sensitive", "primary", "season2_start_date", "season2_end_date"),
  action_specified("infants", "s3", "2018_2019", "sensitive", "primary", "season3_start_date", "season3_end_date"),
  action_specified("infants", "s4", "2019_2020", "sensitive", "primary", "season4_start_date", "season4_end_date"),
  action_covid("infants", "s4", "2019_2020", "sensitive", "primary", "season4_start_date", "season4_end_date"),
  action_specified("infants", "s5", "2020_2021", "sensitive", "primary", "season5_start_date", "season5_end_date"),
  action_covid("infants", "s5", "2020_2021", "sensitive", "primary", "season5_start_date", "season5_end_date"),
  action_specified("infants", "s6", "2021_2022", "sensitive", "primary", "season6_start_date", "season6_end_date"),
  action_covid("infants", "s6", "2021_2022", "sensitive", "primary", "season6_start_date", "season6_end_date"),
  action_specified("infants", "s7", "2022_2023", "sensitive", "primary", "season7_start_date", "season7_end_date"),
  action_covid("infants", "s7", "2022_2023", "sensitive", "primary", "season7_start_date", "season7_end_date"),
  
  comment("# # # # # # # # # # # # # # # # # # #", "SECONDARY ANALYSES", "# # # # # # # # # # # # # # # # # # #"),

  comment("# # # # # # # # # # # # # # # # # # #", "Cohort: Older Adults, Codelist Type: Sensitive, Investigation Type: Secondary", "# # # # # # # # # # # # # # # # # # #"),

  action_specified("older_adults", "s1", "2016_2017", "sensitive", "secondary", "season1_start_date", "season1_end_date"),
  action_specified("older_adults", "s2", "2017_2018", "sensitive", "secondary", "season2_start_date", "season2_end_date"),
  action_specified("older_adults", "s3", "2018_2019", "sensitive", "secondary", "season3_start_date", "season3_end_date"),
  action_specified("older_adults", "s4", "2019_2020", "sensitive", "secondary", "season4_start_date", "season4_end_date"),
  action_specified("older_adults", "s5", "2020_2021", "sensitive", "secondary", "season5_start_date", "season5_end_date"),
  action_specified("older_adults", "s6", "2021_2022", "sensitive", "secondary", "season6_start_date", "season6_end_date"),
  action_specified("older_adults", "s7", "2022_2023", "sensitive", "secondary", "season7_start_date", "season7_end_date"),

  comment("# # # # # # # # # # # # # # # # # # #", "Cohort: Adults, Codelist Type: Sensitive, Investigation Type: Secondary", "# # # # # # # # # # # # # # # # # # #"),

  action_specified("adults", "s1", "2016_2017", "sensitive", "secondary", "season1_start_date", "season1_end_date"),
  action_specified("adults", "s2", "2017_2018", "sensitive", "secondary", "season2_start_date", "season2_end_date"),
  action_specified("adults", "s3", "2018_2019", "sensitive", "secondary", "season3_start_date", "season3_end_date"),
  action_specified("adults", "s4", "2019_2020", "sensitive", "secondary", "season4_start_date", "season4_end_date"),
  action_specified("adults", "s5", "2020_2021", "sensitive", "secondary", "season5_start_date", "season5_end_date"),
  action_specified("adults", "s6", "2021_2022", "sensitive", "secondary", "season6_start_date", "season6_end_date"),
  action_specified("adults", "s7", "2022_2023", "sensitive", "secondary", "season7_start_date", "season7_end_date"),

  comment("# # # # # # # # # # # # # # # # # # #", "Cohort: Children and Adolescents, Codelist Type: Sensitive, Investigation Type: Secondary", "# # # # # # # # # # # # # # # # # # #"),

  action_specified("children_and_adolescents", "s1", "2016_2017", "sensitive", "secondary", "season1_start_date", "season1_end_date"),
  action_specified("children_and_adolescents", "s2", "2017_2018", "sensitive", "secondary", "season2_start_date", "season2_end_date"),
  action_specified("children_and_adolescents", "s3", "2018_2019", "sensitive", "secondary", "season3_start_date", "season3_end_date"),
  action_specified("children_and_adolescents", "s4", "2019_2020", "sensitive", "secondary", "season4_start_date", "season4_end_date"),
  action_specified("children_and_adolescents", "s5", "2020_2021", "sensitive", "secondary", "season5_start_date", "season5_end_date"),
  action_specified("children_and_adolescents", "s6", "2021_2022", "sensitive", "secondary", "season6_start_date", "season6_end_date"),
  action_specified("children_and_adolescents", "s7", "2022_2023", "sensitive", "secondary", "season7_start_date", "season7_end_date"),

  comment("# # # # # # # # # # # # # # # # # # #", "Cohort: Infants, Codelist Type: Sensitive, Investigation Type: Secondary", "# # # # # # # # # # # # # # # # # # #"),

  action_specified("infants", "s1", "2016_2017", "sensitive", "secondary", "season1_start_date", "season1_end_date"),
  action_specified("infants", "s2", "2017_2018", "sensitive", "secondary", "season2_start_date", "season2_end_date"),
  action_specified("infants", "s3", "2018_2019", "sensitive", "secondary", "season3_start_date", "season3_end_date"),
  action_specified("infants", "s4", "2019_2020", "sensitive", "secondary", "season4_start_date", "season4_end_date"),
  action_specified("infants", "s5", "2020_2021", "sensitive", "secondary", "season5_start_date", "season5_end_date"),
