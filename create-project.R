...
action_specified <- function(cohort, season, dates, codelist_type, 
  ...
  splice(
    ...
    action(
      ...
      needs = list(glue("process_dataset_{cohort}_{season}_{codelist_type}_{investigation_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/rsv_{investigation_type}/*.csv"))
    ),
    ...
    action(
      ...
      needs = list(glue("process_dataset_{cohort}_{season}_{codelist_type}_{investigation_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/rsv_{investigation_type}/further_*.csv"))
    ),
    ...
    action(
      ...
      needs = list(glue("process_dataset_{cohort}_{season}_{codelist_type}_{investigation_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/flu_{investigation_type}/*.csv"))
    ),
    ...
    action(
      ...
      needs = list(glue("process_dataset_{cohort}_{season}_{codelist_type}_{investigation_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/flu_{investigation_type}/further_*.csv"))
    ),
    ...
    action(
      ...
      needs = list(glue("process_dataset_{cohort}_{season}_{codelist_type}_{investigation_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/overall_and_all_cause_{investigation_type}/*.csv"))
    ),
    ...
    action(
      ...
      needs = list(glue("process_dataset_{cohort}_{season}_{codelist_type}_{investigation_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/overall_and_all_cause_{investigation_type}/further_*.csv"))
...
action_sensitivity <- function(cohort, season, dates, season_start_date,
  ...
  splice(
    ...
    action(
      ...
      needs = list(glue("process_dataset_sensitivity_{cohort}_{season}_{codelist_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/overall_and_all_cause_model_{investigation_type}/*.csv")),
    ),
...
action_covid_sensitivity <- function(cohort, season, dates, 
  ...
  splice(
    ...
    action(
      ...
      needs = list(glue("process_dataset_sensitivity_{cohort}_{season}_{codelist_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/covid_{investigation_type}/*.csv")),
    ),
    ...
    action(
      ...
      needs = list(glue("process_dataset_sensitivity_{cohort}_{season}_{codelist_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/covid_{investigation_type}/further_*.csv")),
    )
