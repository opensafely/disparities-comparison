...
action_specified <- function(cohort, season, dates, codelist_type, 
  ...
  splice(
    ...
    action(
      ...
      needs = list(glue("process_dataset_{cohort}_{season}_{codelist_type}_{investigation_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/*.csv"))
    ),
...
action_sensitivity <- function(cohort, season, dates, season_start_date,
  ...
  splice(
    ...
    action(
      ...
      needs = list(glue("process_dataset_sensitivity_{cohort}_{season}_{codelist_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/rsv_model_outputs_{cohort}_{dates}_{codelist_type}_sensitivity.csv")),
    ),
    ...
    action(
      ...
      needs = list(glue("process_dataset_sensitivity_{cohort}_{season}_{codelist_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/further_rsv_model_outputs_{cohort}_{dates}_{codelist_type}_sensitivity.csv")),
    ),
    ...
    action(
      ...
      needs = list(glue("process_dataset_sensitivity_{cohort}_{season}_{codelist_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/flu_model_outputs_{cohort}_{dates}_{codelist_type}_sensitivity.csv")),
    ),
    ...
    action(
      ...
      needs = list(glue("process_dataset_sensitivity_{cohort}_{season}_{codelist_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/further_flu_model_outputs_{cohort}_{dates}_{codelist_type}_sensitivity.csv")),
    ),
    ...
    action(
      ...
      needs = list(glue("process_dataset_sensitivity_{cohort}_{season}_{codelist_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/overall_and_all_cause_model_outputs_{cohort}_{dates}_{codelist_type}_sensitivity.csv")),
    ),
    ...
    action(
      ...
      needs = list(glue("process_dataset_sensitivity_{cohort}_{season}_{codelist_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/further_overall_and_all_cause_model_outputs_{cohort}_{dates}_{codelist_type}_sensitivity.csv")),
    )
...
action_covid_sensitivity <- function(cohort, season, dates, 
  ...
  splice(
    ...
    action(
      ...
      needs = list(glue("process_dataset_sensitivity_{cohort}_{season}_{codelist_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/covid_model_outputs_{cohort}_{dates}_{codelist_type}_sensitivity.csv")),
    ),
    ...
    action(
      ...
      needs = list(glue("process_dataset_sensitivity_{cohort}_{season}_{codelist_type}")),
      moderately_sensitive = lst(
        csv = glue("output/results/models/further_covid_model_outputs_{cohort}_{dates}_{codelist_type}_sensitivity.csv")),
    )
...
action_finalise <- function(cohort) {
  splice(
    ...
    action(
      ...
      arguments = c(cohort),
      needs = list(glue("analyse_dataset_{cohort}_covid_s1"),
                   glue("analyse_dataset_{cohort}_covid_s2"),
                   glue("analyse_dataset_{cohort}_covid_s3"),
                   glue("analyse_dataset_{cohort}_covid_s4"),
                   glue("analyse_dataset_{cohort}_covid_s5"),
                   glue("analyse_dataset_{cohort}_covid_s6"),
                   glue("analyse_dataset_{cohort}_covid_s7")),
      moderately_sensitive = lst(
    ...
    action(
      ...
      arguments = c(cohort),
      needs = list(glue("analyse_dataset_{cohort}_overall_and_all_cause_s1"),
                   glue("analyse_dataset_{cohort}_overall_and_all_cause_s2"),
                   glue("analyse_dataset_{cohort}_overall_and_all_cause_s3"),
                   glue("analyse_dataset_{cohort}_overall_and_all_cause_s4"),
                   glue("analyse_dataset_{cohort}_overall_and_all_cause_s5"),
                   glue("analyse_dataset_{cohort}_overall_and_all_cause_s6"),
                   glue("analyse_dataset_{cohort}_overall_and_all_cause_s7")),
      moderately_sensitive = lst(
    ...
    action(
      ...
      moderately_sensitive = lst(
        csv = glue("output/collated/analytic/{cohort}_rsv_model_outputs_collated_sensitivity.csv"))
    ),
    ...
    action(
      ...
      moderately_sensitive = lst(
        csv = glue("output/collated/analytic/{cohort}_flu_model_outputs_collated_sensitivity.csv"))
    ),
    ...
    action(
      ...
      moderately_sensitive = lst(
        csv = glue("output/collated/analytic/{cohort}_covid_model_outputs_collated_sensitivity.csv"))
    ),
    ...
    action(
      ...
      moderately_sensitive = lst(
        csv = glue("output/collated/analytic/{cohort}_overall_and_all_cause_model_outputs_collated_sensitivity.csv"))
    )
