...
action_skimming <- function(cohort, season, dates, codelist_type,
  ...
  splice(
    ...
    action(
      ...
      run = glue("r:latest analysis/data_skim.R input_{cohort}_{dates}{codelist_type}_{investigation_type}.arrow output/data/"),
      # arguments = c(cohort, season, dates, codelist_type, investigation_type),
      needs = list(glue("generate_dataset_{cohort}_{season}_{codelist_type}_{investigation_type}")),
      moderately_sensitive = lst(
    ...
    action(
      ...
      run = glue("r:latest analysis/data_skim.R input_processed_{cohort}_{dates}{codelist_type}_{investigation_type}.arrow output/data/"),
      # arguments = c(cohort, season, dates, codelist_type, investigation_type),
      needs = list(glue("process_dataset_{cohort}_{season}_{codelist_type}_{investigation_type}")),
      moderately_sensitive = lst(
